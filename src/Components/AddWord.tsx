...
function AddWord() {
    ...
    const addWord = (e: React.FormEvent) => {
        ...
        fetch("http://localhost:8080/createWord", {
            ...
            .then((data) => {
                ...
                errorMessage && setErrorMessage("Ordet lades till!");
                input.value = "";
            })
            .catch((error) => {
    ...
    return (
        <div>
            ...
            <h3>Tack för att ni hjälper till att göra spelet bättre genom att utöka ordförrådet!</h3>
            <form onSubmit={addWord}>
                <input type="text" name="word" placeholder="nytt ord" style={{ height: '30px', width: '250px'}} />
